...
from cpu_usb_check import read_file_content, get_pci_name, is_cpu_controller, get_usb_info
...
class TestCpuUsbCheck(unittest.TestCase):
    ...
    def test_get_usb_info_no_realpath(self, mock_read, mock_basename, mock_dirname, mock_realpath):
        mock_realpath.side_effect = Exception
    ...
    def test_get_usb_info_pci_found(self, mock_basename, mock_dirname, mock_realpath):
        ...
        mock_basename.side_effect = lambda x: '0000:00:14.0' if '0000:00:14.0' in x else 'usb1'
        result = get_usb_info('/fake/path')
